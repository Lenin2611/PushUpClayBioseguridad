...
namespace API.Controllers
{
    public class ProgramacionController : BaseController
    {
        ...
        {
            var results = await _unitOfWork.Programaciones.GetAllAsync();
        ...
        public async Task<ActionResult<ProgramacionDto>> Post(ProgramacionDto resultDto)
        {
            ...
            _unitOfWork.Programaciones.Add(result);
        ...
        {
            var exists = await _unitOfWork.Programaciones.GetByIdAsync(id);
            if (exists == null)
            {
                return NotFound();
            }
            ...
            return _mapper.Map<ProgramacionDto>(exists);
        }
